...
WebDriver driver;
	...
	public void editEmployeeDetails() throws Exception {
	    ...
	    //click om pim element
	    CommonUtils.clickElement(pimPage.getPim());
	    ...
	    //identify and select value from dropdown
	    CommonUtils.selectDropDownValue(pimPage.getSearchBy(), "Emp. First Name");
	    
	    CommonUtils.hardWait(5);
	    
	    //identify and enter first name
	    CommonUtils.enterValue(pimPage.getSearchFor(), "ksai", true);
	    
	    CommonUtils.clickElement(pimPage.getSearch());
	    
	    CommonUtils.clickElement(pimPage.getEmpName());
	    
	    CommonUtils.clickElement(pimPage.getEdit());
	    
	    CommonUtils.selectDropDownValue(pimPage.getmstatus(), "Unmarried");
	...
	public void deleteEmployee() throws Exception {
		...
		// Log in to the application using the login page method
			    ...
			    //identify and select value from dropdown
			    CommonUtils.selectDropDownValue(pimPage.getSearchBy(), "Emp. Last Name");
			    
			    CommonUtils.hardWait(5);
			    
			    //identify and enter first name
			    CommonUtils.enterValue(pimPage.getSearchFor(), "sai", true);
			    
			    CommonUtils.clickElement(pimPage.getSearch());
	
			    CommonUtils.clickElement(pimPage.getCheckbox_delete());
			    
			    CommonUtils.clickElement(pimPage.getDelete());
			    
			    TestNGUtility.assertTrue(CommonUtils.getElementText(pimPage.getDeleteMessage()), "Successfully Deleted");
	}
